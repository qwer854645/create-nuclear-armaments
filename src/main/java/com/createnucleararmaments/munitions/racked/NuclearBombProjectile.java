...
public class NuclearBombProjectile extends HEBombProjectile {
    private final Supplier<BlockState> renderedState;

    public NuclearBombProjectile(EntityType<? extends NuclearBombProjectile> type, Level level, Supplier<BlockState> renderedState) {
        super(type, level);
